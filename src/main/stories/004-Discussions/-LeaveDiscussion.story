...
Scenario:  User 2 Leave Discussion
Given Open Baaz App
When I want to login with user2email and password is test123456
And I navigate to disucssions
Then User leave discussion room



Scenario:  Check If Member leave Successfuly
Given Open Baaz App
When I want to login with user1email and password is test123456
And I navigate to disucssions
Then Check if recent group message contains left this discussion and discussion title equal Automation Group 
